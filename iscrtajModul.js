...
if (raspored == null) {
      ...
      return;*/
      return ("Greska - raspored nije kreiran");
    ...
    if (vrijemePocetak >= vrijemeKraj) {
      /* alert("Greska - vec postoji termin u rasporedu u zadanom vremenu");
       return;*/
      return ("Greska - u rasporedu ne postoji dan ili vrijeme u kojem pokusavate dodati termin");
    ...
    for (i = s1; i < s2; i = i + 0.5) {
      ...
      if (polje.getAttribute("colspan") > 0) {
        ...
        if ((i <= vrijemeKraj && i >= vrijemePocetak) || vrijemePocetak >= vrijemeKraj) {
          /* alert("Greska - vec postoji termin u rasporedu u zadanom vremenu");
           return;*/
          return ("Greska - vec postoji termin u rasporedu u zadanom vremenu");
